...
public class Vista_Story40_RpcTest {
	...
	public void testResultListIENs_VistaClient() throws Exception {
		...
		try {
			System.out.println(client.getIENsMapForResponseList());
		} finally {
	...
	public void testStory40_TBI_Consult_Save_Scenario_1() throws Exception {
		...
		try {
			...
			varsMap.put("TBI_consult_where", "Baghdad, Iraq");
			//varsMap.put("TBI_consult_when", "2003");
			//varsMap.put("TBI_consult_how", "Shell exploded within 100 feet");
			System.out.println(client.saveTBIConsultOrders(va, varsMap));
		} finally {
			client.closeConnection();
		}
	}
	...
	public void testGetConsultInfo() throws Exception {
		...
		VistaLinkClient client = vistaLinkClientStrategy.getClient();
		try {
			System.out.println(client.getConsultInfo("C"));
		} finally {
			client.closeConnection();
		}
	}
