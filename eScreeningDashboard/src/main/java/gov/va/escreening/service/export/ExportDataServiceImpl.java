...
public class ExportDataServiceImpl implements ExportDataService, BeanFactoryAware {
	...
	private List<List<DataExportCell>> getTableContent(
		...
		for (VeteranAssessment assessment : filteredAssessments) {
			List<DataExportCell> row = buildExportRowArrayList(assessment, identifiedExportType);
	...
	private List<DataExportCell> buildExportRowArrayList(
		...
		for (ModuleEnum module : ModuleEnum.values()) {
			List<DataExportCell> cells = module.apply(this.bf, assessment);
