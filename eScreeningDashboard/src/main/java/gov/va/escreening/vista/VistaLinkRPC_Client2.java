	...
	public Map<String, Object> saveTBIConsultOrders(
		...
		return new VistaLinkRpcInvoker<Map<String, Object>>() {
			...
			protected List<Object> prepareReqParams() {
				...
				reqParams.add(getRefRespLst(veteranAssessment, varsMap));
			...
			private Map<String, Object> getRefRespLst(
				...
				respLstMap.put(RpcRequest.buildMultipleMSubscriptKey(String.format("\"WP\",%s,1,1,0", commentIEN)), prepareTbiConsultReasonText(varsMap));
			...
			private String prepareTbiConsultReasonText(
				...
				sb.append("\tPersistence symptoms.\n");
				sb.append("\tPositive OIF/OEF TBI screen.\n");
				sb.append("OIF/OEF TBI screen completed date: " + (varsMap.get("TBI_consult_when") == null ? "Not Provided" : varsMap.get("TBI_consult_when")) + "\n");
				sb.append("When & Where did the TBI occur:\n");
				sb.append("\t" + (varsMap.get("TBI_consult_where") == null ? "Not provided" : varsMap.get("TBI_consult_where")) + "\n");
				sb.append("How did the TBI occur:\n");
				sb.append("\t" + (varsMap.get("TBI_consult_how") == null ? "Not Provided" : varsMap.get("TBI_consult_how")) + "\n");
