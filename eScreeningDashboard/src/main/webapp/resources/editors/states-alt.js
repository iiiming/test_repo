    ...
    [          '$stateProvider', '$urlRouterProvider',
        function ($stateProvider,   $urlRouterProvider) {
            ...
            $stateProvider
                ...
                .state('questions-selectsinglemultiple',{
                    url:'/questions-selectsinglemultiple',
                    templateUrl:'resources/editors/views/questions/selectsinglemultiplequestion.html'
                })

                .state('questions-selectsinglemultiplematrix',{
                    url:'/questions-selectsinglemultiplematrix',
                    templateUrl:'resources/editors/views/questions/selectsinglemultiplematrixquestion.html'
                })
