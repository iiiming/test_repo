...
EScreeningDashboardApp.models.Survey = function (jsonSurveyObject) {
    ...
    this.toString = function () {
        return "Survey {id: " + id + ", name: " + name + ", description: " + description + ", version: " + version +
            ", displayOrder: " + displayOrder + ", isMHA: " + mha + ", markedForDeletion: " + markedForDeletion +
