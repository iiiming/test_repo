...
<form id="dataExportForm" name="dataExportForm"  ng-submit="searchDatabase()">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="mainDiv">
              <div class="row">
				<div class="col-md-12"><h1>Export Data</h1></div>
				</div>
              <div class="row">
                <div class="col-md-12">
          ...
          <div class="col-md-12">
              ...
              <div id="mainContent">
                ...
                <table id="exportDataTable" name="exportDataTable" report-table="overrideOptions" fn-data-callback="getDataForSearch" class="table table-striped  table-hover" width="100%">
                  <thead>
                    <tr>
