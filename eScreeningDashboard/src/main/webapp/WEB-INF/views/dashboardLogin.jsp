                  ...
                  <div class="form-group">
                    <div class="field_">
                      <div id="userNameParamDiv" class="rightLogin_">
                      	<label for="lastFourSsn">Username </label>
                        <input name="userNameParam" id="userNameParam" type="text"  maxlength="30" tabindex="1" placeholder="Enter username"  class="form-control input-lg" required>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    <div class="field_">
                      <div id="passwordParamDiv" class="rightLogin_">
                      	<label for="lastFourSsn">Password </label>
                        <input name="passwordParam" id="passwordParam" type="password"  maxlength="30" tabindex="1" class="form-control input-lg" placeholder="Enter your password"  required>
                      </div>
                    </div>
                  </div>
                </div>
