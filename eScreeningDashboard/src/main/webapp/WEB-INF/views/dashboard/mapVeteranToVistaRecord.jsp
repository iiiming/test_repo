...
<div class="container">
	<div class="row">
 		...
 		<div class="row">
			<div class="col-md-8 pull-left"><h1>Map Veteran to VistA Record</h1></div>
 		</div>
							...
							<c:forEach var="item" items="${searchResultList}">
								<tr>
									...
									<td align="right">
										...
										<form:form modelAttribute="mapVeteranToVistaRecordFormBean" method="post">
											<form:hidden path="veteranId"/>
									 ...
									 <a href="#" data-vid="${item.veteranId}" data-vien="${item.veteranIen}" class="btn btn-primary btn-xs  pull-right push btn_margin_right" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-chevron-right"></span> Quick View </a>
									</td>
								</tr>
							</c:forEach>
	                	</c:if>
