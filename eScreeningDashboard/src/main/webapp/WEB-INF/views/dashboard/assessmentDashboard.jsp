              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="bottomContent" id="mainContent">
                    <table id="assessmentDashboardTable" name="assessmentDashboardTable" report-table="overrideOptions" fn-data-callback="getDataForSearch" class="table table-striped  table-hover">
                      <thead>
                        <tr>
