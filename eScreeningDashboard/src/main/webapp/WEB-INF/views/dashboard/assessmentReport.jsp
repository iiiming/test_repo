        ...
        <div class="row">
          <div class="col-md-12">
            <div id="mainContent">
              ...
              <table id="assessmentReportTable" name="assessmentReportTable" report-table="overrideOptions" fn-data-callback="getDataForSearch" class="table table-striped  table-hover">
                <thead>
                  <tr>
                    <th scope="col">ID</th>
