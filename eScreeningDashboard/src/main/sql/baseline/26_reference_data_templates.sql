...
${MODULE_START}
 	...
 	<#assign footer_section>
		...
		<#assign outputText = outputText + "*Explained confidentiality and the limits of confidentiality.${LINE_BREAK}">
		<#assign part = "">
		<#if (var1599.value)??>
		...
		<#if ((var821.value)?? && var821.value == "true") || ((var9421.value)?? && var9421.value == "true")
			...
			<#assign outputText = outputText + "*Contact information of this writer, OEF/OIF brochure, and suicide prevention card were given to the Veteran. Encouraged to call for any further questions or concerns.${LINE_BREAK}${LINE_BREAK}">
		...
		<#if errorText?has_content>
			${errorText}${LINE_BREAK}
		<#else>
			${outputText}${LINE_BREAK}
		</#if>
	</#assign>
...
${MODULE_START}
  <#assign concerns_section> 
    ...
    <#if hasValue(getSelectMultiDisplayText(var200)) >
      The Veteran identified ${getSelectMultiDisplayText(var200)} as the presenting concern(s).
					${LINE_BREAK}
					${LINE_BREAK}
	</#if>
  ...
  <#assign demo_section>
	...
	<#if (var30.children)?? && (var40.children)?? && (var20.children)?? && (var143.children)??
		...
		<#if isSelectedAnswer(var30,var33) >
          ,  <#t>
        <#else>
          ${""?left_pad(1)}whom is ${getSelectOneDisplayText(var30)},  
        </#if> 
...
<#if (var50.children)?? && (var60.children)?? && (var70.children)?? && (var80.children)?? && (var100.children)??
    ...
    <#if hasValue(getSelectOneDisplayText(var50)) >
      The Veteran reported completing ${getSelectOneDisplayText(var50)}.  
    </#if> 
    ...
    <#if hasValue(getSelectOneDisplayText(var60)) && hasValue(getSelectOneDisplayText(var70)) >
      The Veteran reported being currently ${getSelectOneDisplayText(var60)}, who usually works as an ${getFreeformDisplayText(var70)}. 
    <#elseif hasValue(getSelectOneDisplayText(var60)) && !(hasValue(getFreeformDisplayText(var70)))>
      The Veteran reported being currently ${getSelectOneDisplayText(var60)}.  
    <#elseif !(hasValue(getSelectOneDisplayText(var60))) && hasValue(getFreeformDisplayText(var70)) >
      The Veteran reported usually working as an ${getFreeformDisplayText(var70)}.  
    </#if>
    ...
    <#if var80?? >
      ...
      <#else>
        their income is derived from ${getSelectMultiDisplayText(var80)}. 
      </#if> 
    </#if> 
    <#--The Veteran is married.-->
    <#if hasValue(getSelectOneDisplayText(var100)) >
      The Veteran is ${getSelectOneDisplayText(var100)}.  
    </#if> 
  ...
  <#assign social_section>
    ...
    <#if hasValue(getSelectOneDisplayText(var110)) && hasValue(getSelectMultiDisplayText(var90)) >
      ...
      <#if wasAnswerNone(var90)>
        alone.  
      <#else> 
        with ${getSelectMultiDisplayText(var90)}. 
      </#if>
    <#elseif hasValue(getSelectOneDisplayText(var110)) && !(hasValue(getSelectMultiDisplayText(var90)))>
      The Veteran ${getSelectOneDisplayText(var110)}.  
    <#elseif !(hasValue(getSelectOneDisplayText(var110))) && hasValue(getSelectMultiDisplayText(var90)) >
     The Veteran lives with ${getSelectMultiDisplayText(var90)}. 
    </#if>
      ...
      <#else>
        ...
        <#if !(getNumberOfTableResponseRows(var130) = -1) >
          ...
          <#elseif (getNumberOfTableResponseRows(var130) = 1) >
            The Veteran has 1 child who is ${getTableMeasureDisplayText(var130)} years old. 
          <#elseif (getNumberOfTableResponseRows(var130) > 1) >
            The Veteran has ${getNumberOfTableResponseRows(var130)} children who are ${getTableMeasureDisplayText(var130)} years old.  
          </#if>
        </#if>
      </#if>
    </#if>
    ...
    <#if hasValue(getSelectMultiDisplayText(var160)) >
    	${LINE_BREAK}${LINE_BREAK}Source(s) of support is/are : ${getSelectMultiDisplayText(var160)}.
    </#if>
    
    <#--The Veteran indicated a history of physical violence .-->
    <#if hasValue(getSelectOneDisplayText(var150)) >
    	${LINE_BREAK}${LINE_BREAK}The Veteran ${getSelectOneDisplayText(var150)} a history of physical violence or intimidation in a current relationship.
    </#if>
...
<#assign promis_section>
	...
	<#else>
  	...
  	The Veteran had a score of ${score}, indicating that they currently have ${avgText} emotional support.
  <#else>
  	${getNotCompletedText()}
  </#if>
  </#assign>
...
${MODULE_START}
  ...
  <#assign housing_section>
	...
	<#-- var763: ${var763}<br><br>     var2000: ${var2000!""}<br><br>  --> 
  	<#if (var2000.children)?? && ((var2000.children)?size > 0)  >
		...
		<#elseif (var2000.children[0].key == "var761")
				...
				The Veteran ${getSelectOneDisplayText(var2000)} been living in stable housing for the last 2 months. ${LINE_BREAK}${LINE_BREAK}
				The Veteran has been living ${getSelectOneDisplayText(var2002)}.${LINE_BREAK}${LINE_BREAK}
...
${MODULE_START}
  ...
  <#assign advance_dir_section> 
    ...
    <#if hasValue(getSelectMultiDisplayText(var800)) >
      ...
      ${LINE_BREAK}${LINE_BREAK}The Veteran requests to receive information in ${getSelectMultiDisplayText(var800)}.  <#t>
    </#if>
    <#if hasValue(getSelectMultiDisplayText(var820)) >
      ...
      ${LINE_BREAK}${LINE_BREAK}The Veteran reported ${getSelectMultiDisplayText(var820)} an Advance Directive or Durable Power of Attorney for Healthcare.  <#t>
    </#if>
     <#if hasValue(getSelectMultiDisplayText(var826)) >
      	<#-- If no, would like information about this document? -->
      	${LINE_BREAK}${LINE_BREAK}The Veteran ${getSelectMultiDisplayText(var826)} like information about an Advance Directive.  <#t>
    </#if>     
	...
	<#-- The Veteran feels that combat or military service affected his/her religious views in the following way: god. -->
  	<#if hasValue(getSelectOneDisplayText(var440)) >
		<#if isSelectedAnswer(var440,var443)>
			The Veteran does not know how combat or military service has affected his/her religious views.  
		<#else>
			The Veteran feels that combat or military service ${getSelectOneDisplayText(var440)} have an affect on his/her religious views.
		</#if>
    </#if>  	
...
${MODULE_START}
 	...
 	<#assign history_section>
		<#if (var3180.children)??  && (var3180.children?size>0) && (var3160.children)?? && (var3160.children)?has_content>
			...
			<#if typeIsComplete && branchIsComplete && beg_yrIsComplete && end_yrIsComplete 
				...
				<#if ((outputText?trim?length) > 0)>
					<#assign outputText = 
						...
						+ ", received an " + dischargeType + " discharge in " + end_yr + " at the rank of " + rank + ".${LINE_BREAK}${LINE_BREAK}")>
				<#else>
		  ...
		  <#if allAnswersPresent>
			The Veteran also served in the following operations or combat zones: ${getSelectMultiDisplayText(var3160)}.${LINE_BREAK}${LINE_BREAK}
		  </#if>
		<#else>	 
			${getNotCompletedText()}.
		</#if>
...
<#if !Q3_isAnswerNone && !Q3_complete && (var5130.children)?? && (var5130.children)?has_content>
	...
	<#if allComplete>
		...
		<#else>
			<#if Q1_isAnswerNone>
				The Veteran reported receiving no disciplinary actions.${LINE_BREAK}${LINE_BREAK}
			<#else>
				The Veteran reported receiving the following disciplinary actions: ${getSelectMultiDisplayText(var5000)}.${LINE_BREAK}${LINE_BREAK}
			</#if>

			<#if Q2_isAnswerNone>
				The Veteran reported receiving no personal awards or commendations.${LINE_BREAK}${LINE_BREAK}
			<#else>
				The Veteran reported receiving the following personal awards or commendations: ${getSelectMultiDisplayText(var5020)}.${LINE_BREAK}${LINE_BREAK}
			</#if>
			...
			The Veteran was deployed ${frag} to the following ${frag2} during the following time ${frag3}:${LINE_BREAK}${LINE_BREAK}
			${all_rows}${LINE_BREAK}
		</#if>
	<#else>
		${getNotCompletedText()}
...
${MODULE_START}
  <#assign phq15_section>
	  ...
	  <#if (var1020.children)?? && (var1030.children)?? && (var1040.children)?? && (var1050.children)?? && (var1060.children)?? 
...
${MODULE_START}
  <#assign pain_intensity_section>
	...
	<#--  -->
		...
		<#assign score = -1>
		<#if score1?? && score2?? && score3?? && score4?? && score5?? && score6?? && score7?? && score8?? && score9??>
			<#assign score = score1 + score2 + score3 + score4 + score5 + score6 + score7 + score8 + score9	>
		</#if>

		
		<#assign scoreText = "">
		
		The Veteran endorsed having ${getSelectOneDisplayText(var2550)} pain currently. Over the past week the veteran reported a pain intensity of ${getSelectOneDisplayText(var2560)} with ${getSelectOneDisplayText(var2570)} average pain. 
  ...
  <#assign prior_mh_treatment_section>   
	...
	<#if var1520?has_content> 	
		<#if isSelectedAnswer(var1520, var1521)><#-- was answer "none" or something else -->
			The Veteran reported being diagnosed with no prior mental health issues in the last 18 months.${LINE_BREAK}${LINE_BREAK}
		<#else>
			The Veteran endorsed being diagnosed with ${getSelectMultiDisplayText(var1520)} within the last 18 months.${LINE_BREAK}
		</#if>
	</#if>
	
	<#if var1530?has_content>
		<#if isSelectedAnswer(var1530, var1531)><#-- was answer "none" or something else -->
			The Veteran reported receiving no prior mental health treatment for a mental health diagnosis in the last 18 months.${LINE_BREAK}
		<#else>
			The Veteran endorsed having received the following treatments within the last 18 months for a mental health diagnosis: ${getSelectMultiDisplayText(var1530)}.${LINE_BREAK}
		</#if>
	</#if>
 	...
 	<#assign section>
		...
		<#--  var4200: ${var4200!""}<br><br>  -->
 		...
 		<#if (var4119.value)?? && (var4239.value)?? && (var4319.value)?? && (var4419.value)?? 
			...
			<b>Understanding and Communicating</b> - the veteran had an average score of ${var4119.value} which indicates ${getScoreText(var4119.value)} disability. ${LINE_BREAK}${LINE_BREAK}
			...
			<B>Participation in Society</b> - the veteran had an average score of ${var4789.value}  which indicates ${getScoreText(var4789.value)} disability.  
  ...
  <#assign caffeine_section>
  	<#if (var3050.children)?? && (var3050.children?size > 0)> 
		<#if (getScore(var3050) == 0)>
			The Veteran reported consuming no caffeinated beverages per day.
		<#elseif (getScore(var3050) >= 1) && (getScore(var3050) <= 998)>
			The Veteran reported consuming ${getSelectOneDisplayText(var3050)} caffeinated beverages per day.
		<#else>
			${getNotCompletedText()}
		</#if>	
	<#else>
  ...
  <#assign tobacco_section>			
    ...
    <#if hasValue(getSelectOneDisplayText(var600)) >
		...
		<#if isSelectedAnswer(var600,var601)>
			The Veteran ${part1}.${LINE_BREAK}
		</#if>
		<#if isSelectedAnswer(var600,var602)>
			The Veteran ${part1} ${part3}.${LINE_BREAK}
		</#if>
		<#if isSelectedAnswer(var600,var603)>
			The Veteran ${part1} ${part2}.
		</#if>
	</#if>
	...
	<#--  -->
		...
		<#else>			
			...
			<#assign fragments = []>
				...
				The MDQ (Hyper mood) screen was ${t}.${LINE_BREAK}${LINE_BREAK}
...
${MODULE_START}
  <#assign mst_section>
	...
	<#if var2005?? && (isSelectedAnswer(var2003,var2005) || isSelectedAnswer(var2003,var2004))>
	 	<#if (mstMilitaryScore == 0 )>
			The Veteran\s MST screen was ${(scoreText)!"notset"}. 
	 	<#elseif (mstMilitaryScore == 1)>
  ...
  <#assign pclc_section>
	...
	<#if score??> 	
		...
		<#if (score >=0  && score <= 998)>
			The Veteran\'s PCL-C Screen was ${scoreText!} with a PCL-C score of ${score!("-1"?number)}. 
		<#elseif score == 999 >
			${getNotCompletedText()}.
		</#if>
	</#if>
...
${MODULE_START}
  <#assign ptsd_section>
	...
	<#if score??> 	
		...
		<#if (score >=0  && score <= 998)>
			The Veteran\'s PC-PTSD Screen was ${scoreText!} with a PC-PTSD score of ${score}. 
		<#elseif score == 999 >
			The Veteran did not complete PC-PTSD Screen.
		</#if>
	</#if>
	<#else>
		${getNotCompletedText()}.
