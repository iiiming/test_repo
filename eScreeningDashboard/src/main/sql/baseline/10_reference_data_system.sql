...
INSERT template_type (template_type_id, name, description) VALUES (10, 'Veteran Summary Header', 'Template used to generate the header of a Veteran Summary. Associated with a Battery.');
INSERT template_type (template_type_id, name, description) VALUES (11, 'Veteran Summary Footer', 'Template used to generate the footer of a Veteran Summary. Associated with a Battery.');
INSERT template_type (template_type_id, name, description) VALUES (12, 'Veteran Summary Entry', 'Template used to generate the body elements of a Veteran Summary. Associated with a Module.');
